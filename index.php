...
?>
  ...
  <form method="post" action="export.php">
     <input type="submit" name="export" class="btn btn-success pull-right" value="Download Data" />
  ...
  <hr>
		...
		<thead>
        	...
        	while($row = mysqli_fetch_array($run_data))
        	{
				...
				<td class='text-center'>$u_l_name,   $u_f_name   $u_family</td>
				<td class='text-center'>$u_card</td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<center><h4>Create Student</h4></center>
...
<input type="text" class="form-control" name="staff_id" maxlength="12" placeholder="Enter Course">
</div>
...
<div class="form-group col-md-4">
<label for="family">Middle Initial</label>
<input type="text" class="form-control" name="family" placeholder="Enter Middle Initial">
...
<input type="phone" class="form-control" name="user_phone" placeholder="Enter Mobile No." maxlength="15" required>
</div>
...
<div class="form-group col-md-6">
<label for="aadharno">Age</label>
<input type="text" class="form-control" name="user_aadhar" maxlength="12" placeholder="Enter Age">
</div>
...
<input type="text" class="form-control" name="police_station" placeholder="Enter Place of Birth">
</div>
</div>
...
<input type="text" class="form-control" name="village" placeholder="Enter Address">
</div>
...
while($row = mysqli_fetch_array($run_data))
{
	...
	echo "
		...
		<div class='modal-dialog'>
			<div class='modal-content'>
			<div class='modal-header'>
				<h5 class='modal-title' id='exampleModalLabel'><strong>Profile</strong> <i class='fa fa-user-circle-o' aria-hidden='true'></i></h5>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					<div class='col-sm-1 col-md-3'>
						...
						<br />
						<strong>Issue Date</strong> : $time
					</div>
					<div class='col-sm-6 col-md-3'>
						<h3 class='text-primary'>$name $family $name2</h3>
						<p class='text-secondary'>
						<strong>Course :</strong> $staff <br>
						
						
						<i class='fa fa-venus-mars' aria-hidden='true'></i> <strong>$gender</strong>
						<br />
						<strong>Age :</strong> $aadhar <br>
						<strong>Date of Birth :</strong> $Bday <br>
						<strong>Place of Birth :</strong> $police <br>
						
						<strong>Father's Name :</strong> $father <br>
						<strong>Mother's Name :</strong> $mother <br>
						
						<i class='fa fa-home' aria-hidden='true'><strong> Address : </strong></i> $village, <br> $dist - $pincode
						<br />
						</p>
						<!-- Split button -->
					</div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='inputAddress'>Course</label>
		<input type='text' class='form-control' name='staff_id' maxlength='12' placeholder='Enter Course' value='$staffCard'>
		</div>
		...
		<div class='form-group col-md-4'>
		<label for='family'>Middle Initial</label>
			<input type='text' class='form-control' name='family' placeholder='Enter Middle Initial' value='$family'>
		</div>
		</div>
		...
		<div class='form-group col-md-6'>
		<label for='inputPassword4'>Mobile No.</label>
		<input type='phone' class='form-control' name='user_phone' placeholder='Enter Mobile No.' maxlength='15' value='$phone' required>
		</div>
		...
		<div class='form-group col-md-6'>
		<label for='inputAddress2'>Place of Birth</label>
		<input type='text' class='form-control' name='police_station' placeholder='Enter Place of Birth' value='$police'>
		</div>
		</div>
		...
		<div class='form-group col-md-6'>
		<label for='inputAddress'>Address</label>
		<input type='text' class='form-control' name='village' placeholder='Enter Address' value='$village'>
		</div>
		<div class='form-group col-md-4'>
		<label for='inputCity'>Country</label>
